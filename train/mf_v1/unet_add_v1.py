...
from SpSN_v2.core import sq_model_mr_v1_add as mdoel
...
exp_name = "finetuner_scale{}_m{}_rep{}_mr_v1_02".format(data.scale[0], m, block_reps)
...
out_name = "mid_val_n_train_mf_v1_02"
